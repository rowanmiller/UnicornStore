            ...
            if (context.AllMigrationsApplied())
            {
                if (!context.Products.Any())
                {
                    ...
                    context.Products.AddRange(
                        ...
                        new Product { DisplayName = "Mens Unicorn Tee (Blue)", MSRP = 19.95M, CurrentPrice = 18.95M, Category = mensShirts, ImageUrl = "/images/products/MensTee_Blue.png", Description = "Share your love of unicorns with the world. Quality cotton t-shirt with a long lasting print." },
                        new Product { DisplayName = "Mens Unicorn Tee (Grey)", MSRP = 19.95M, CurrentPrice = 10.95M, Category = mensShirts, ImageUrl = "/images/products/MensTee_Grey.png", Description = "Share your love of unicorns with the world. Quality cotton t-shirt with a long lasting print." },
